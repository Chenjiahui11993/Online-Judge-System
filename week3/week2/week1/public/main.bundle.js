...
var AppComponent = (function () {
    function AppComponent() {
        ...
        this.userNames = ["abc", "efg"];
    }
    AppComponent.prototype.checkClick = function () {
        if (this.userName === "") {
            console.log("12345");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_problem_detail_problem_detail_component__ = __webpack_require__("../../../../../src/app/components/problem-detail/problem-detail.component.ts");
...
var routes = [
    ...
    {
        path: 'problems',
        component: __WEBPACK_IMPORTED_MODULE_2__components_problem_list_problem_list_component__["a" /* ProblemListComponent */]
    },
    {
        path: 'problems/:id',
        component: __WEBPACK_IMPORTED_MODULE_1__components_problem_detail_problem_detail_component__["a" /* ProblemDetailComponent */]
    },
    {
        path: '**',
        redirectTo: 'problems'
...
var EditorComponent = (function () {
    function EditorComponent(collaboration, rouete) {
    ...
    EditorComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_collaboration_service__["a" /* CollaborationService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["a" /* ActivatedRoute */]])
    ], EditorComponent);
...
var ProblemDetailComponent = (function () {
    ...
    ProblemDetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            ...
            _this.dataService.getProblem2(+params['id'])
                .then(function (problem) { return _this.problem = problem; })
                .catch(function (err) { return _this.problem = err; });
        });
    };
...
var DataService = (function () {
    ...
    // }
    DataService.prototype.getProblem2 = function (id) {
